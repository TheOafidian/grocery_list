...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(_("Thanks for registering, %(username)s",username=form.username.data))
        return redirect(url_for("login"))
...
def follow(username):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(_("Now following: %(u)s!",u=username))
        return redirect(url_for("index"))
    else:
        return redirect(url_for("index"))
...
def unfollow(username):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(_("You are no longer following %(u)s",u=username))
        return redirect(url_for("index"))
    else:
        return redirect(url_for("index"))
